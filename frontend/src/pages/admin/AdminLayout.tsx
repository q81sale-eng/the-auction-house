...
const Ic = {
  ...
  watchRef: <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/><circle cx="12" cy="12" r="3" strokeWidth="1.5"/></svg>,
...
export const AdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/admin/watch-reference',    label: t.watchRefNav,           icon: Ic.watchRef   },
